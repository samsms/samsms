...
<%
    ...
    JSONObject json = new JSONObject(q.Url("https://api.themoviedb.org/3/genre/tv/list?api_key=5185fbe676a7c3b437ea476efdcbe4ff"));
    ...
    try {
        ...
        for(int i=0;i<jsonarray.length();i++) {
            ...
            out.print("<div class='mv-container'>"
                    + "<div class='mv-title'>"+ "<h1>"+obj.get("name")+" Show</h1>"+ "</div>"
                     + "<div class='mvs'>");
            Random r = new Random();
            int p= r.nextInt(100) + 1;
        JSONObject list = new JSONObject(q.Url("https://api.themoviedb.org/3/discover/tv?api_key=5185fbe676a7c3b437ea476efdcbe4ff&with_genres="+  obj.get("id")+"&page="+p));
    ...
    try {
        ...
        for(int l=0;l<mvlist.length();l++) {
            ...
            if(!ob.get("poster_path").equals(null))
            {
            out.print(
                    "<a href='"+obj.get("id")+"'>"+"<div class='mv'><div class='img'><img src='https://image.tmdb.org/t/p/w500"+ob.get("poster_path")+"'/></div>"
                    + "<div class='mv-title'><h1>"+ob.get("name")+"</h1></div></div></a>");
            }
        }
